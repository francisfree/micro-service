package com.example.card.config.exception;

import com.example.card.config.exception.dto.ErrorResponse;
import com.example.card.utils.CaseConverter;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<Object> handleAppInputErrorException(IllegalArgumentException ex) {
